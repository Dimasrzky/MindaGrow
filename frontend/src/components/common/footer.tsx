    ...
    <footer className="bg-background border-t">
      <div className="container py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Personalized education platform for children aged 5-12,
              combining AI-powered learning with gamification.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/education-tips" className="text-sm text-muted-foreground hover:text-foreground transition">
                  Education Tips
                </Link>
              </li>
              <li>
                <Link href="/case-studies" className="text-sm text-muted-foreground hover:text-foreground transition">
                  Case Studies
                </Link>
              </li>
              <li>
                <Link href="/help-center" className="text-sm text-muted-foreground hover:text-foreground transition">
                  Help Center
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            &copy; {currentYear} MindaGrow. All rights reserved.
          </p>
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <Link href="https://instagram.com" className="text-muted-foreground hover:text-foreground" target="_blank" rel="noopener noreferrer">
